...
cummax_by_group_cpp <- function(x, group) {
    .Call(`_DIDmultiplegtDYNpolars_cummax_by_group_cpp`, x, group)
}

compute_var_covar_matrix_cpp <- function(U_Gg_vars, first_obs, l_XX, G_XX) {
    .Call(`_DIDmultiplegtDYNpolars_compute_var_covar_matrix_cpp`, U_Gg_vars, first_obs, l_XX, G_XX)
}

compute_U_Gg_global_cpp <- function(U_Gg_plus, U_Gg_minus, N1_weight, N0_weight) {
    .Call(`_DIDmultiplegtDYNpolars_compute_U_Gg_global_cpp`, U_Gg_plus, U_Gg_minus, N1_weight, N0_weight)
}

compute_clustered_variance_cpp <- function(U_Gg_var, first_obs_gp, first_obs_clust, cluster, G_XX) {
    .Call(`_DIDmultiplegtDYNpolars_compute_clustered_variance_cpp`, U_Gg_var, first_obs_gp, first_obs_clust, cluster, G_XX)
}

propagate_treatment_change_cpp <- function(ever_change, group, time, T_max) {
    .Call(`_DIDmultiplegtDYNpolars_propagate_treatment_change_cpp`, ever_change, group, time, T_max)
}

initialize_effect_columns_cpp <- function(nrow, l_XX, include_placebo) {
    .Call(`_DIDmultiplegtDYNpolars_initialize_effect_columns_cpp`, nrow, l_XX, include_placebo)
}

compute_weighted_sum_cpp <- function(x, mask) {
    .Call(`_DIDmultiplegtDYNpolars_compute_weighted_sum_cpp`, x, mask)
}

compute_delta_D_g_cpp <- function(delta_plus, delta_minus, switchers_tag, l_XX) {
    .Call(`_DIDmultiplegtDYNpolars_compute_delta_D_g_cpp`, delta_plus, delta_minus, switchers_tag, l_XX)
}

compute_full_vcov_cpp <- function(U_Gg_vars_effects, U_Gg_vars_placebos, first_obs, se_effects, se_placebos, G_XX) {
    .Call(`_DIDmultiplegtDYNpolars_compute_full_vcov_cpp`, U_Gg_vars_effects, U_Gg_vars_placebos, first_obs, se_effects, se_placebos, G_XX)
}

lag_diff_by_group_cpp <- function(x, group, lag_periods) {
    .Call(`_DIDmultiplegtDYNpolars_lag_diff_by_group_cpp`, x, group, lag_periods)
}

shift_by_group_cpp <- function(x, group, periods) {
    .Call(`_DIDmultiplegtDYNpolars_shift_by_group_cpp`, x, group, periods)
}

conditional_sum_by_group_cpp <- function(x, condition, group1, group2, group3_ = NULL) {
    .Call(`_DIDmultiplegtDYNpolars_conditional_sum_by_group_cpp`, x, condition, group1, group2, group3_)
}

sum_by_group_cpp <- function(x, group) {
    .Call(`_DIDmultiplegtDYNpolars_sum_by_group_cpp`, x, group)
}

mean_by_group_cpp <- function(x, group) {
    .Call(`_DIDmultiplegtDYNpolars_mean_by_group_cpp`, x, group)
}
...
compute_U_Gg_core_cpp <- function(diff_y, distance_to_switch, N_t_g, N_gt_control, never_change, N_gt, time_XX, T_g, group, first_obs, G_XX, N_inc, i, t_min, T_max) {
    .Call(`_DIDmultiplegtDYNpolars_compute_U_Gg_core_cpp`, diff_y, distance_to_switch, N_t_g, N_gt_control, never_change, N_gt, time_XX, T_g, group, first_obs, G_XX, N_inc, i, t_min, T_max)
}
...
compute_U_Gg_var_temp_cpp <- function(diff_y, E_hat_gt, DOF_gt, distance_to_switch, N_t_g, N_gt_control, never_change, N_gt, time_XX, T_g, G_XX, N_inc, i) {
    .Call(`_DIDmultiplegtDYNpolars_compute_U_Gg_var_temp_cpp`, diff_y, E_hat_gt, DOF_gt, distance_to_switch, N_t_g, N_gt_control, never_change, N_gt, time_XX, T_g, G_XX, N_inc, i)
}

compute_dof_indicator_cpp <- function(N_gt, diff_y, never_change, N_t, indicator_type) {
    .Call(`_DIDmultiplegtDYNpolars_compute_dof_indicator_cpp`, N_gt, diff_y, never_change, N_t, indicator_type)
}

compute_cohort_mean_cpp <- function(values, weights, dof_indicator, group1, group2, group3_ = NULL) {
    .Call(`_DIDmultiplegtDYNpolars_compute_cohort_mean_cpp`, values, weights, dof_indicator, group1, group2, group3_)
}
